...
### 2026-09-25 — SE wave 2 HANDOFF (all 6 agents killed by session limit; files are resumable)
Relaunch each with the SAME spec; the skill's resume step continues partial files. Utility names = join keys (from scan_SE*.csv utility_name).
- Programs, Sonnet → data/raw/program_chunks/chunk_SE_carolinas.csv: Duke Energy Carolinas, LLC (NC+SC); Duke Energy Progress, LLC (NC+SC); Georgia Power Company; Alabama Power Company; Dominion Energy South Carolina; Santee Cooper (South Carolina Public Service Authority); Jackson EMC; Cobb EMC; Sawnee EMC; GreyStone Power Corporation; Walton EMC; EnergyUnited; Berkeley Electric Cooperative. rto SERC-nonRTO. Priorities: PowerPair, NC solar choice/bridge, Power Manager/EnergyWise/BYOT/PowerShare, SC Act 62, GA Power TOU + BYOD pilot, AL capacity reservation charge.
- Programs, Sonnet → chunk_SE_florida.csv: Florida Power & Light Company; Duke Energy Florida, LLC; Tampa Electric Company; JEA; Orlando Utilities Commission; Withlacoochee River Electric Cooperative; Lee County Electric Cooperative (LCEC); SECO Energy; Clay Electric Cooperative, Inc.; Lakeland Electric; City of Tallahassee Utilities; Gainesville Regional Utilities. rto FRCC-nonRTO.
- Programs, Sonnet → chunk_SE_tva.csv: "Tennessee Valley Authority" (wholesale provider rows: Smart Thermostat Rewards, PowerFlex/Peak Rewards, TOU wholesale, Dispersed Power/Green Connect, EV) + LPC retail rows: Nashville Electric Service; Memphis Light, Gas and Water Division; Middle Tennessee Electric; Knoxville Utilities Board; EPB (Electric Power Board of Chattanooga); Huntsville Utilities; Volunteer Energy Cooperative; Cumberland Electric Membership Corporation. rto TVA.
- Interconnection, Opus → data/raw/interconnection/ic_SEa_{state,utility}.csv: NC (done, Secondary — upgrade via NCUC PDF in browser pane), SC, GA + utility deltas for the Carolinas/GA list above.
